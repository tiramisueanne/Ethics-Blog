...
YouTube’s business model is sometimes ethical, however, hosting hostile and illegal content and making it monetizable through ads is in no way ethical. YouTube has the responsibility to filter out harmful content and comments and only put ads on advertiser-friendly content. Therefore, if a user is publishing false information, the user should not be able to make money from advertisements on Youtube because “fake news” can create harm in the form of misinformation, which can damage the lives of people trying to find solutions to “fake news” when there isn’t one. Youtube should also not be able to profit off of harmful content. Technology plays a neutral role in this situation because it is both harmful and helpful. Although it can spread harmful and false content, which can hurt innocent people, it can also expose actual harm to the world and bring justice to those who were wronged.
